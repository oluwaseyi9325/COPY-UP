  ...
  return (
    <div className='container mb-5' >
     <div style={{height:"50px"}}></div>
      ...
      <div className='row'>
      <div className='col-lg-4 col-md-7 col-sm-7 mt-5'>
      ...
      <div className='col-lg-8 col-md-7 col-sm-7 text-right  '>
        <Image src={require("../asset/banner.png")} width={600} className="bannerBack" />
      </div>
  </div>
      </div>
